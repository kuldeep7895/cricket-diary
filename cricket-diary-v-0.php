        ...
        if( (($_SESSION['tosswon']=="team1" and $_SESSION['batobowl']=="bat") or ($_SESSION['tosswon']=="team2" and $_SESSION['batobowl']=="bowl"))){
            ...
            if (array_key_exists('runs',$_GET)){
                ...
                if($_GET['byes']== on or $_GET['legbyes'] == on or $_GET['wide'] == on){
                    ...
                    $_SESSION["BOWL ".$_SESSION["bowlteam"]][$_SESSION['bowlerindex']][1] = $_SESSION[$_SESSION["bowlteam"]."overballs"];        
      ...
      <div class="scoreboard row">
            ...
            <div class="col-4">
                ...
                <?php
                        ...
                        if ($_SESSION[$_SESSION["bowlteam"]."over"]!=0 and $_SESSION[$_SESSION["bowlteam"]."overballs"]!=0){
                            echo '<span style="position:relative;top:-5px;color:#909090">CRR<br>'.(($_SESSION[$_SESSION["batteam"]."runs"])/($_SESSION[$_SESSION["bowlteam"]."over"]*6+$_SESSION[$_SESSION["bowlteam"]."overballs"])).'</span>';
                        }
                        else{
